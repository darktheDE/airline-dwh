...
1.  **Tạo Database**: Khởi tạo 2 database rỗng trên SQL Server:
    *   `Airline_OLTP`
    *   `AirlineDWH`
...
*   **Lưu ý**: File `flights.csv` nặng khoảng 800MB, quá trình nạp có thể mất từ 1-3 phút tùy cấu hình máy.

### Bước 2: Khởi tạo Structure cho Data Warehouse
