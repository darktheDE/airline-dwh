...
- **Ý nghĩa**: Đảm bảo dữ liệu trong kho luôn cập nhật mới nhất theo nguồn. Nếu thông tin (tên sân bay, thành phố...) thay đổi ở nguồn, hệ thống sẽ ghi đè dữ liệu mới lên dữ liệu cũ tại DWH mà không làm tăng số lượng dòng.
